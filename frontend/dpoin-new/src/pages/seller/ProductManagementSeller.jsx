// ✅ FILE: src/pages/seller/ProductManagementSeller.jsx (FINAL DENGAN REVISI KATEGORI)
...
// ✅ REVISI: Definisikan kategori produk dalam array
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white rounded-xl shadow p-4 mb-4 border border-gray-200">
            ...
            <div className="mb-4">
              ...
              {/* ✅ REVISI: Gunakan array untuk membuat opsi */}
              <select
                id="category"
                name="category"
                value={form.category}
